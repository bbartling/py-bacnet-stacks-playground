...
| **11** | **Agentic BAS from spec**                                                                    | Agentic-software experiment: product spec, SKILL.md skills, memory, and cron drive Codex to grow the supervisory app; electrical-phase Who-Is workers plus scheduled builder wakes. Folder: vibe_code_apps_11.                                                                                                        | **Active**  |
