...
| **19** | **[CSV FDD dashboards (Buildings 50 & 100)](vibe_code_apps_19/)** · [AGENTS.md](vibe_code_apps_19/AGENTS.md) | **Active.** Offline pandas twin of [Open-FDD Pandas Cookbook](https://bbartling.github.io/open-fdd/rules/cookbook/pandas-cookbook.html): [`csv_fdd_dashboard`](vibe_code_apps_19/csv_fdd_dashboard/) (Plotly + Flask) + [`fdd_dashboard_model`](vibe_code_apps_19/fdd_dashboard_model/) (VAV catalog). External CSV via `data_paths.local.yaml`. | **Active** |
