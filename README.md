...
**Active development** is in **`vibe_code_apps_11/`**, **`vibe_code_apps_12/`**, and **`vibe_code_apps_14/`** (BACnet routing research). Checkpoints **1–10** are historical demos; **13** and **15–16** are planned future apps (`vibe_code_apps_13/` is a reserved slot).
