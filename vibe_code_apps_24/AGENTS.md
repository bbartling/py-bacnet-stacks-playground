...
**Mission:** run a **live** residential RTU twin with BACnet priority arrays + FastAPI HTML BAS graphic. Commands resolve instantly on the PointBus; sensors move on plant ticks.
...
| BAS graphic | [`static/`](static/) |
| Design | [`docs/superpowers/specs/2026-09-08-vibe24-eplus-bacnet-twin-design.md`](docs/superpowers/specs/2026-09-08-vibe24-eplus-bacnet-twin-design.md) |
