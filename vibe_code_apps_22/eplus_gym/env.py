"""Lakeside Gym adapter on the rleplus EnergyPlusEnv contract.

Production import of ``rleplus.env.energyplus`` is required. The generic
runner must lazy-import pyenergyplus (CI-safe). Lakeside DualSP extras live
in ``runner.py``. Never call ``action_space.sample()``.
"""
...
class EnergyPlusEnv(gym.Env):
    ...
    def __init__(self, env_config: Dict[str, Any]):
        ...
        _import_rleplus_energyplus_env()
        self.episode = -1
        self.timestep = 0
