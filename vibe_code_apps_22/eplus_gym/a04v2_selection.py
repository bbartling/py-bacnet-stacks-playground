...
def track_b_state_from_plan(plan: dict[str, Any] | None) -> dict[str, bool]:
    """A plan file is planned only. Builder landing is not LIVE EnergyPlus executed."""
    plan = plan or {}
    return {
        "track_b_plan_created": bool(plan.get("track_b_plan_created", plan.get("track_b_planned", True if plan else False))),
        "track_b_builder_prototype_created": bool(plan.get("track_b_builder_prototype_created", False)),
        "track_b_structural_validation_passed": bool(plan.get("track_b_structural_validation_passed", False)),
        "track_b_live_energyplus_executed": bool(plan.get("track_b_live_energyplus_executed", False)),
        ...
        # Legacy aliases: executed meant LIVE. Do not treat a builder as executed.
        "track_b_planned": bool(plan.get("track_b_plan_created", plan.get("track_b_planned", True if plan else False))),
        "track_b_executed": bool(plan.get("track_b_live_energyplus_executed", False)),
    }
...
def compute_selection_verdict(
    *,
    ...
    track_b_plan_created: bool | None = None,
    track_b_builder_prototype_created: bool = False,
    track_b_structural_validation_passed: bool = False,
    track_b_live_energyplus_executed: bool | None = None,
    ...
    *and* this function is given long_campaign_ramp_passed=True.
    ...
    live = bool(track_b_live_energyplus_executed) if track_b_live_energyplus_executed is not None else bool(
        track_b_executed if track_b_attempted is None else track_b_attempted
    )
    planned = bool(track_b_plan_created) if track_b_plan_created is not None else bool(track_b_planned)
    executed = live
    ...
    return {
        ...
        "track_b_planned": planned,
        "track_b_plan_created": planned,
        "track_b_builder_prototype_created": bool(track_b_builder_prototype_created),
        "track_b_structural_validation_passed": bool(track_b_structural_validation_passed),
        "track_b_live_energyplus_executed": live,
        "track_b_executed": live,
