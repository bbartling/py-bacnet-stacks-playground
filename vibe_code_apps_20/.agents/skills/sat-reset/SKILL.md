...
## Invoke when
When evidence suggests fixed or poorly performing SAT strategy.

## Required inputs
- SAT/SP, zone demand, reheat, OAT, fan status
- approved baseline
...
5. Model an achievable reset strategy and note fan/reheat interactions.
