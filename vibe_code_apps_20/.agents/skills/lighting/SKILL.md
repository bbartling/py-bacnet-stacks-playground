...
## Invoke when
When evidence suggests lighting power or schedule opportunity.

## Required inputs
- LPD, fixture inventory, schedules, controls
- approved baseline
...
5. Keep LPD reduction separate from controls where results need distinct attribution.
