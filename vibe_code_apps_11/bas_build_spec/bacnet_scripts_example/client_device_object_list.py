#!/usr/bin/env python3
"""BACpypes3 client: read object-list on a known remote device instance.

Prefer point_discovery.py for Who-Is sweep first.

  python3 bas_build_spec/bacnet_scripts_example/client_device_object_list.py \
