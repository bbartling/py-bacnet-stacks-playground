"""BRICK-compatible time-series references for DynamoDB external_ref mapping."""
...
def brick_point_entity_id(site_id: str, building_id: str, series_id: str) -> str:
    """Stable entity @id for a telemetry point (SparkQL / graph)."""
...
def brick_timeseries_ref(
    *,
    ...
    external_ref (series_id) is the DynamoDB partition key for telemetry rows.
    """
