"""Single-user session tokens for Vibe12 web (no Cognito)."""
...
_SECRET = os.environ.get("VIBE12_AUTH_SECRET", "").strip()
_USER = os.environ.get("VIBE12_WEB_USER", "").strip()
_PASSWORD = os.environ.get("VIBE12_WEB_PASSWORD", "").strip()
_TOKEN_TTL_SEC = int(os.environ.get("VIBE12_AUTH_TTL_SEC", str(7 * 86400)))
