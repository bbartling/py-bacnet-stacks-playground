...
BACnet Who-Is → devices-only CSV (no point object-list reads).
  ...
  python -m edge_bacnet.discover_devices 0 100 -o devices_discovered.csv \\
...
from edge_bacnet.discover_lib import (
    collect_i_ams,
    parse_limits,
    safe_read_property,
    set_show_warnings,
...
def _build_parser() -> SimpleArgumentParser:
    ...
    parser.add_argument("-o", "--output", default="devices_discovered.csv")
