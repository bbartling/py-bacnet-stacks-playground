...
export const mountDocs: MountFn = (outlet) => {
  render(
    html`
      <div class="space-y-4">
        <div>
          <h1 class="text-2xl font-semibold tracking-tight">Deployment &amp; platform notes</h1>
          <p class="mt-1 text-sm text-muted-foreground">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              >bbartling.github.io/easy-aso</a
            >
            · Open-FDD references:
            <a
              class="text-primary underline"
        ...
        <div class="rounded-xl border border-border/60 bg-card/50 shadow-sm">
          <div class="p-6 pt-6">
            <pre
              class="max-h-[70vh] overflow-auto whitespace-pre-wrap rounded-md bg-muted/50 p-4 font-mono text-xs leading-relaxed"
            >${CHEAT}</pre>
          </div>
        </div>
      </div>
