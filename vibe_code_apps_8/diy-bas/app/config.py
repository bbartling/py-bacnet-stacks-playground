...
class Settings:
    ...
    trend_retention_days: int = int(os.environ.get('DIY_BAS_TREND_RETENTION_DAYS', '14'))
    ...
    shared_outside_air_point: str = os.environ.get('DIY_BAS_SHARED_OAT_POINT', 'web-weather-dry-bulb')
    ahu_device_instance: int = int(os.environ.get('DIY_BAS_AHU_DEVICE_INSTANCE', '1100'))
    vav_device_instance: int = int(os.environ.get('DIY_BAS_VAV_DEVICE_INSTANCE', '12026'))
