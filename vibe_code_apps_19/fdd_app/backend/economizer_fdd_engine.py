...
Note: SV-* sensor QA and ECON-* faults overlap with cookbook_rules.py (canonical).
Use cookbook_engine.equipment_view() for dashboard tabs; this engine remains for
economizer_diagnostics.html until fully migrated.
"""
