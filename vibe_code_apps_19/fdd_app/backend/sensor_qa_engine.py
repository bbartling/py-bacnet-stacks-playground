...
Note: SV-RANGE / SV-FLATLINE / SV-SPIKE overlap cookbook_rules.py — prefer cookbook_engine
for new work; this module is kept for economizer_fdd_engine integration only.
"""
