...
RULES: list[CookbookRule] = [
    ...
    CookbookRule(
        ...
        _sweep_spike, params=[
            CookbookParam("spike_scale", "Spike limit scale", "×", 0.25, 3.0, 0.25, 1.0),
            CONFIRM_PARAM(5.0),
        ], sensor_sweep=True, confirm_seconds=300,
    ),
    CookbookRule(
    ...
    CookbookRule(
        ...
        ["ahu"], ["mat", "oa_t", "rat"],
        "MAT falls outside min(OAT,RAT) − 2.2°F … max(OAT,RAT) + 2.2°F envelope — implausible mixed-air reading.",
    ...
    CookbookRule("CHW-1", "Low chilled-water ΔT", "plant", ["chiller"],
        ...
        chw1, params=[CookbookParam("min_dt", "Min ΔT", "°F", 1.0, 12.0, 0.5, 4.0), CONFIRM_PARAM(15.0)], confirm_seconds=900),
    ...
    CookbookRule("DMP-1", "OA damper leakage", "ahu", ["ahu"],
        ...
        dmp1, params=[CookbookParam("leak_delta", "Leak ΔT", "°F", 0.5, 6.0, 0.5, 2.0), CONFIRM_PARAM(15.0)], confirm_seconds=900),
