...
REQUIRED_UI_ENTRYPOINTS: tuple[str, ...] = (
    ...
    "app.browser_session:browser_pointer_allowed",
    "app.session_workspace:ensure_session_id",
    "app.session_workspace:sweep_stale_workspaces",
    "app.session_workspace:wipe_workspace",
    "app.fdd_runtime:make_session_config",
    "app.fdd_runtime:export_engineering_bundle",
